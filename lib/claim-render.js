...
function renderStep4(supplier, isPowerhouse) {
  ...
  return `
      ...
      <form class="wizard-form ${lockClass}" data-step="4">
        ...
        <p class="muted">Buyers fill in their name, email, materials, and quantity, and the system routes the request to you the same business day — Pro listings see it the next day.</p>
        <div class="cta-row">
          ${isPowerhouse
